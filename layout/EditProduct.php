...
<?php
    ...
    $UnitPrice = $_POST['price'];
       ...
       if($_FILES['file']['name'] == ''){
            $image = $rows_up['ProductImage'];
       }else{
            $image = $_FILES['file']['name'];
       }
      // $sql_u = "UPDATE `category`SET `CategoryName` = '$categoryname' , `Description` = '$description', `Picture` = '$image'";
       $sql_pro = "UPDATE `product` SET `ProductName`='$productname',`CategoryID`=$categoryid,`UnitPrice`=$UnitPrice,`ProductImage`='$image' WHERE ProductID = $id";
       if(isset($_POST["upload"])){
        ...
        <div class="right">
            ...
            <div class="content_basic">
                ...
                <form method ="POST"  enctype="multipart/form-data">
                    ...
                    <input type="text" name="productname" class="col-6" value="<?php echo $rows_up['ProductName']; ?>"><br/>
                    ...
                    <br/>
                    <label >Giá</label><br/>
                    <input type="text" name="price" class="col-6"  value="<?php echo $rows_up['UnitPrice'];?>">
                    <br/>
