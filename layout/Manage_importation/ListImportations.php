        ...
        <div class="right">
            ...
            <div class="bang">
                ...
                <table border="1"  cellspacing="0.4px" >
                    ...
                    $sql = "select * from importations join vendors on importations.vendor_id = vendors.id join users on users.id = importations.user_id";
                   ...
                   $i = 0;
                    ...
                    while($row = $query->fetch_row()) {
                        ...
                        <tr>
                            <td width=200px>".$i."</td>
                            <td width=200px>".$row[0]."</td>
                            <td width=200px>".$row[3]."</td>
                           
                            <td width=200px>".$row[5]."</td>
                            <td width=200px>".$row[11]."</td>
                            <td width=200px> <button class='green'><a href='./DetailImportation.php?id=".$row[0]."'>Chi tiết</a></button><button class='blue'><a href='./EditImportation.php?id=".$row['id'] ."'>Sửa</a></button><button class='red'><a href='./XoaDM.php?id=".$row['id'] ."'onclick='return XacNhanXoa()'>Xóa</a></button></td>
